                        ...
                        <div>
                            <div className='grid grid-cols-[40%_60%] gap-12 items-center m-4 py-4 px-8 lg:px-16'>
                                <div className='flex flex-col gap-2 lg:gap-6'>
                                    <h3 className='text-lg md:text-2xl xl:text-4xl font-semibold text-[#26221E]'>In it for the long haul</h3>
                                    <h4 className='text-md md:text-lg xl:text-2xl font-medium text-white'>A task manager you can trust for life.</h4>
                                    <h5 className='text-sm md:text-sm xl:text-xl text-white font-medium '>We’re committed to building the best to-do app — without ever compromising our values.</h5>

                                </div>
                                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 p-4 sm:gap-8 sm:p-8 items-center text-center">

                                    <div className="flex flex-col items-center gap-3">
                                        <img loading="lazy" src="appTodo.avif" alt="1k+ downloads" className=" h-20 sm:h-40" />
                                        <h3 className="text-[#89DA63] text-xs sm:text-sm font-medium whitespace-nowrap">
                                            1k+ downloads
                                        </h3>
                                    </div>

                                    <div className="flex flex-col items-center gap-3">
                                        <img loading="lazy" src="todouser.avif" alt="Pro Users" className="h-20 sm:h-40" />
                                        <h3 className="text-[#89DA63] text-xs sm:text-sm font-medium whitespace-nowrap">
                                            Pro Users
                                        </h3>
                                    </div>
                                    ...
                                    <div className="flex flex-col items-center gap-3">
                                        <img loading="lazy" src="countriesTodo.avif" alt="Few Countries" className="h-20 sm:h-40" />
                                        <h3 className="text-[#89DA63] text-xs md:text-sm font-medium whitespace-nowrap">
                                            Few Countries
                                        </h3>
                                    </div>
